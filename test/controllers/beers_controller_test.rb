...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, hop_id: @beer.hop_id, malt_id: @beer.malt_id, name: @beer.name, yeast_id: @beer.yeast_id }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { abv: @beer.abv, hop_id: @beer.hop_id, malt_id: @beer.malt_id, name: @beer.name, yeast_id: @beer.yeast_id }
    assert_redirected_to beer_path(assigns(:beer))
  end
