...
class HopsControllerTest < ActionController::TestCase
  ...
  test "should create hop" do
    assert_difference('Hop.count') do
      post :create, hop: { alpha_acids: @hop.alpha_acids, country_id: @hop.country_id, name: @hop.name }
    end
  ...
  test "should update hop" do
    patch :update, id: @hop, hop: { alpha_acids: @hop.alpha_acids, country_id: @hop.country_id, name: @hop.name }
    assert_redirected_to hop_path(assigns(:hop))
  end
